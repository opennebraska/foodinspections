function InspectionsDatabase() {
	...
	this.getPointsInBounds = function(centerLat, centerLng, radius, callback) {
		var query = "SELECT firm_id, lat, lng FROM ne_restaurant_inspections l WHERE ST_Dwithin(l.the_geom::geography, ST_GeogFromText('POINT(" + centerLng + " " + centerLat + ")'), " + radius + ")";
